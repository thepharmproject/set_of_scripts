...
--------|------|------|-----
BeautifulSoup | Easy to use  Popular | Cannot parse dynamic content (i.e. Javascript) | https://anaconda.org/anaconda/beautifulsoup4  
https://pypi.org/project/beautifulsoup4/
selenium | Can manipulate dynamic content | More difficult to tune data parsers | https://anaconda.org/anaconda/selenium  
https://pypi.org/project/selenium/
tweepy | | Comptatibility issues between versions | https://anaconda.org/conda-forge/tweepy  
https://tweepi.com/
